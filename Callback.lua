...
if tonumber(msg.sender.user_id) == 916165019 then
msg.Name_Controller = '𝗠𝗬𝗧𝗛️'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 916165019 then
...
if tonumber(Message_Edit.sender.user_id) == 916165019 then
data.The_Controller = 1
elseif tonumber(Message_Edit.sender.user_id) == 916165019 then
data.The_Controller = 1
